...
namespace Test_UtilisateurConnnecté
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            UtilisateurConnecté utilisateur1 = new UtilisateurConnecté("Bonhomme", "Paul", new DateTime(2001, 11, 18), "paul_b63", "MotDePassePaul", "polo.clash@gmail.com", new List<JeuVidéo>());
